...
db.serialize(() => {
    ...
    // Update existing keys to new owner
...
// ========== FIXED: GENERATE KEY WITH CUSTOM SUPPORT ==========
app.post('/admin/generate-key', requireAuth, (req, res) => {
    ...
    console.log('📝 Generate request:', { name, enable_custom, custom_key });
    ...
    if (enable_custom === 'true' || enable_custom === true || enable_custom === 'on') {
...
app.listen(PORT, () => {
    ...
    console.log('✅ Endpoints page with click-to-copy!');
    console.log('=====================================\n');
});

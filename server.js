...
app.post('/admin/generate-key', requireAuth, (req, res) => {
    ...
    console.log('📝 Form data:', { name, enable_custom, custom_key, expiry });
    ...
    // Check if custom key is enabled (supports checkbox value 'on' or 'true')
    const isCustomEnabled = enable_custom === 'true' || enable_custom === 'on' || enable_custom === true;

...
db.serialize(() => {
    ...
    db.get(`SELECT COUNT(*) as count FROM available_apis`, [], (err, row) => {
        db.run(`DELETE FROM available_apis`, [], () => {
            const apis = [
                // ===== NEW APIs =====
                ['vehicle_info', '🚗 Vehicle to Info', '/api/vehicle-info', 'vehicle', '{"vehicle":"UP42BB2572"}', 'Get vehicle challan/info from vehicle number'],
                ...
                ['number_info', '📱 Number to Info', '/api/number-info', 'q', '{"q":"9876543321"}', 'Complete number information lookup'],
                ...
                ['email_info', '📧 Email Info', '/api/email-info', 'q', '{"q":"bhulgayakudhdaalle"}', 'Email address information lookup'],
                
                // ===== OLD APIs (Old Telegram REMOVED) =====
                // 'telegram' REMOVED - only new telegram-num exists
            ...
            console.log('✅ APIs updated - Old Telegram REMOVED, ' + apis.length + ' total APIs');
        });
    });
});
...
// ========== API PROXY MAP (Old Telegram REMOVED) ==========
const apiProxyMap = {
    // ===== NEW APIs =====
...
app.listen(PORT, () => {
    ...
    console.log('✅ Old Telegram API REMOVED');
    console.log('✅ New Telegram API: /api/telegram-num');
    console.log('=====================================\n');
});
